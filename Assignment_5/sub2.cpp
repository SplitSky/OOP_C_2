...
class matrix {
    ...
    public:
        ...
        matrix(matrix &numbers){
            ...
            this->set_data(numbers.get_data(), col*row);
        }
        ...
        matrix & operator=(matrix&& numbers) { // move assignment operator
        ...
        matrix & operator=(matrix &numbers) { // assignment operator for deep copying
...
int main() {
    ...
    std::cout << "Det 3x3: " << det_a << std::endl;
    std::cout << "Det 4x4: " << det_b << std::endl; 
